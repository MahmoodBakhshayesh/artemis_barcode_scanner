...
@available(iOS 10.0, *)
class BarcodeScannerView: NSObject, FlutterPlatformView, AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
...
//    var hasBarcodeReader:Bool!
    ...
    init(
        ...
        _view = UIView()
        self.channel = FlutterMethodChannel(name:"artemis_barcode_scanner",binaryMessenger: messenger!)
        self.frame = frame
