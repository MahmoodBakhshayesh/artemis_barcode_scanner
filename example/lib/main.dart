...
class _MyAppState extends State<MyApp> {
  ...
  final _artemisBarcodeScannerPlugin = ArtemisBarcodeScanner();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          await _artemisBarcodeScannerPlugin.getPlatformVersion() ?? 'Unknown platform version';
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Column(children: [
          Expanded(
            child: ArtemisBarcodeScannerView(
              onBarcodeRead: (b){
