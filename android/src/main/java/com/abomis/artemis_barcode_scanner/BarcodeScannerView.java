...
class BarcodeScannerView implements PlatformView, BarcodeScannerViewInterface, MethodChannel.MethodCallHandler, FlutterMethodListener {
    ...
    public BarcodeScannerView(ActivityPluginBinding activityPluginBinding, BinaryMessenger binaryMessenger, int viewId) {
        this.activityPluginBinding = activityPluginBinding;
        Log.println(Log.ASSERT,"2,","HERE");
        this.channel = new MethodChannel(binaryMessenger, "artemis_barcode_scanner");
...
//                    imageAnalyzer = new ImageAnalysis.Builder().build();
                    ...
                    imageAnalyzer.getBackpressureStrategy();
                } else if (modeID == 2) {
//                    imageAnalyzer = new ImageAnalysis.Builder().build();
